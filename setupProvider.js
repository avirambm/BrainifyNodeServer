...
SetupProvider.prototype.reset = function (callback) {
    ...
    this.db.collection('users', function(err, collection) {
        collection.remove({},{w:1}, function(error, removedNum){
            ...
            emotivProvider.getUserCollection(function (error, users_collection) {
                if (error) {
                    // Log this!
...
SetupProvider.prototype.insertSongsData = function (callback) {
    ...
    spotifyProvider.getGlobalRatingCollection(function (error, global_rating_collection) {
        if (error) {
            // Log this!
            console.log("Error: Error getting global rating collection!");
            console.log(error);
    ...
    spotifyProvider.getPrivateRatingCollection(function (error, private_rating_collection) {
        if (error) {
            // Log this!
            console.log("Error: Error getting global rating collection!");
            console.log(error);
